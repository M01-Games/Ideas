...
void AFPSEnemy::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bForSweep, const FHitResult& Hit)
{
...
void AFPSEnemy::OnSensed(const TArray<AActor*>& UpdatedActors)
{
...
void AFPSEnemy::SetNewRotation(FVector TargetPosition, FVector CurrentPosition)
{
...
void AFPSEnemy::DealDamage(float DamageAmount)
{
	Health -= DamageAmount;
